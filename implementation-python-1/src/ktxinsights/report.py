...
def generate_report(file_path: str, out_dir_str: str, outlier_ms: int):
    """Generates a report from a JSONL file."""
    ...
    for ev in read_jsonl(file_path):
        et = ev.get("type")
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <p class="stat"><b>Outliers (≥ {outlier_ms/1000:.1f}s):</b> {outlier_count} | <b>Simulator-Injected Outliers:</b> {injected_outliers}</p>
